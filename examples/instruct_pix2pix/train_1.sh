...
export VAL_IMAGE_URL="https://raw.githubusercontent.com/Scene-Genie/finetune_instructp2p/main/val.jpg"
...
accelerate launch --mixed_precision="fp16" train_instruct_pix2pix.py \
  ...
  --original_image_column="resized_touched_image" \
  --edited_image_column="resized_touched_image" \
  --edit_prompt_column="blank_prompt" \
  --num_train_epochs=3 \
  --resolution=512 \
  --train_batch_size=1 \
